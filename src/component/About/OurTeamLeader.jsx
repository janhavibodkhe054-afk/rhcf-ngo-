...
const OurTeamLeader = () => {
  ...
  const executiveLeaders = [
    ...
    },
    {
      name: "Harsh Bhabhra",
      role: "Treasurer",
      desc: "Harsh Bhabhra brings strong financial acumen and transparency to the organization. He ensures meticulous financial management, compliance with statutory requirements, and optimal utilization of funds.",
      photo: "/harsh.png",
    },
    {
      name: "Divya Kanwar",
    ...
    },
    {
      ...
      role: "Member",
      desc: "Pramod Kumar Gupta provides valuable strategic guidance and operational excellence across multiple projects.",
      photo: "/pramod.jpeg",
    },
    {
      name: "Ghasi Laal Meena",
      role: "Member",
      desc: "Ghasi Lal Meena is deeply connected with rural communities. He works tirelessly to strengthen field-level coordination and ensure successful project outreach.",
      photo: "/harsh.jpeg",
    },
  ];
  const localHeroes = [
    {
      ...
      desc: "Pushpendra Kumar is a seasoned development professional with extensive experience in managing large-scale social projects.",
      photo:
        "https://img.magnific.com/free-photo/handsome-smiling-man-wearing-green-shirt-standing-against-blue-background_662251-587.jpg",
    },
    {
      name: "Bharat Kumawat",
      position: "Accountant",
      desc: "Bharat Kumawat is a dedicated and detail-oriented finance professional responsible for managing all financial operations of the organization.",
      photo:
        "https://img.magnific.com/premium-photo/smiling-indian-business-man-executive-isolated-gray-vertical-portrait_562687-3165.jpg",
    },
    {
      name: "Arti Singh",
      position: "Digital & Design Coordinator",
      desc: "Arti Singh is a tech-savvy and creative professional who efficiently manages office operations using modern AI tools and digital platforms.",
      photo: "/arti.png",
    },
  ];
